...
from unet import UNet, NET, MobileNetV3
...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='./checkpoints/checkpoint_epoch34_mask.pth', metavar='FILE',
                        help='Specify the file in which the model is stored')
    parser.add_argument('--input', '-i', default = "./predict/imgs3", metavar='INPUT', help='Filenames of input images')
